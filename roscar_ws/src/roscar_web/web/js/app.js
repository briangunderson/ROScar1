/**
 * app.js — Main entry point, ROS connection, tab switching, E-STOP
...
import { initLidar }    from './lidar.js';
...
function notifyModules(event, data) {
  moduleCallbacks.forEach(cb => { try { cb(event, data); } catch(e) { console.error(e); } });
}
